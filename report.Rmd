...
Compared to the last one, how does your first digital semester work for you so far in respect to studies, general mood and expectations.
...
## Q1.1: Compared to the last one, how does your first digital semester work for you so far regarding studies?

```{r}

general %>%
  ggplot(aes( x =`... regarding your studies:`)) +
  geom_bar() +
...
## Q1.2: Compared to the last one, how does your first digital semester work for you so far regarding your general mood?

```{r}

general %>%
  ggplot(aes( x =`... regarding your general mood:`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x ="rating",
    y = "frequency",
    title = "How is your general mood during the digital semester? (1 = bad , 10 = great)"
  )
...
## Q1.3: Compared to the last one, how does your first digital semester work for you so far regarding regarding your expectations (worse/better than expected?)?

```{r}

general %>%
  ggplot(aes( x =`... regarding your expectations (worse/better than expected?):`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x ="rating",
    y = "frequency",
    title = "How is the digital semester regarding your expectations? (1 = worse , 10 = better)"
  )
...
## Q1.4: Here is are the answers given what reasons account for the results above
...
In this section we were are asking for the students experience with the online semester, in particular with different formats of teaching/learning.

They were asked to indicate how much they agree with the following statements with the ongoing semester in mind on a 10-point Likert scale ranging from 1 (= I do not agree) to 10 (= I agree)
...
```
## Q2.1 Different Session Types

What students say how well the online format works for certain session types:


```{r}
d_lectures %>%
  # mutate(`lectures` = as.character(`lectures`)) +
  ggplot(aes(x = `lectures`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for LECTURES (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `tutorials`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for TUTORIALS (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `Testate`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for TESTATE (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `SmallSeminars`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for SMALL SEMINARS (<=15 people) \n(1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `LargeSeminars`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for LARGE SEMINARS (>15 people) \n(1 = do not agree; 10 = agree)"
  )
...
```{r}
d_lectures %>%
  ggplot(aes(x = `ReadingClub`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for READING CLUBS (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `StudyProject`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for STUDY PROJECTS \n(1 = do not agree; 10 = agree)"
  )

```


## Q2.2 Different Tasks

What students say how well the online format works for certain tasks:
...
d_lectures %>%
  ...
  labs(
    x = "rating",
    y = "frequency",
    title = "The online format works well for giving or listening to presentation \n(1 = do not agree; 10 = agree)"
  )
...
d_lectures %>%
  ...
  labs(
    x = "rating",
    y = "frequency",
    title = "Working on homework exercises online as a group works fine \n(1 = do not agree; 10 = agree)"
  )
...
d_lectures %>%
  ...
  labs(
    x = "rating",
    y = "frequency",
    title = "Working together on other projects (presentation, paper,..) online works well \n(1 = do not agree; 10 = agree)"
  )

```
## Q2.3 Other Activities

What students say how well the online format works for other things:
...
d_lectures %>%
  ...
  labs(
    x = "rating",
    y = "frequency",
    title = "Working online as a student assistant works fine (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `Extracurricular`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "Participating in extracurricular activities (e.g. student body, university politics)\n online works fine (1 = do not agree; 10 = agree)"
  )

```
```{r}
d_lectures %>%
  ggplot(aes(x = `AdminTasks`)) +
  geom_bar() +
  scale_x_discrete(limits = 1:10) +
  labs(
    x = "rating",
    y = "frequency",
    title = "Managing general administration tasks (e.g. examination office) remotely works fine.  \n(1 = do not agree; 10 = agree)"
  )

```
## Q2.4 Specifics and Suggestions
...
Offering additional Question and Answer Sessions helps the students to understand the material
(144, 72, 89)
